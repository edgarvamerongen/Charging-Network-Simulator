...
# Pure config, deliberately NOT tied to the Notion-synced plane catalog: ids
# there are regenerated by the sync (v1 matched on them and live silently
# dropped the stops whose ids had changed). These are the fixed VISION numbers
# told on nrg2fly.com; edit them here.
EMBED_TIMELINE = [
    {'year': '2024', 'name': 'Velis Electro',        'seats': 2,  'range_km': 100},
    {'year': '2027', 'name': 'Beta Alia CX300',      'seats': 6,  'range_km': 350},
    {'year': '2030', 'name': 'Vaeridion Microliner', 'seats': 9,  'range_km': 500},
    {'year': '2035', 'name': 'Elysian E9X',          'seats': 90, 'range_km': 750},
]
...
def embed():
    ...
    # Timeline mode (range tier only): fixed vision stops, see EMBED_TIMELINE.
    timeline = list(EMBED_TIMELINE) if (timeline_on and tier == 'range') else None
